...
+const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("jackiebrowser");
...
-const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("chrome");
-const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("chrome");
+const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("jackiebrowser");
+const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("jackiebrowser");
 #endif  // OS_*
...
+const base::FilePath::CharType kBrowserResourcesDll[] = FPL("jackiebrowser.dll");
+const base::FilePath::CharType kElfDll[] = FPL("jackiebrowser_elf.dll");
