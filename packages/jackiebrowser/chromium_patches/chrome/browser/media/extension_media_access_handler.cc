...
+// 9. JackieBrowser extensions (AI Side Panel and Bug Reporter)
...
+         extension->id() == "egfdjlfmgnehecnclamagfafdccgfndp" ||
+         // JackieBrowser extensions
+         extensions::jackiebrowser::IsJackieBrowserExtension(extension->id());
 }
...
+  // For JackieBrowser extensions in sidepanel, allow audio for teach mode
+  if (extensions::jackiebrowser::IsJackieBrowserExtension(extension->id())) {
