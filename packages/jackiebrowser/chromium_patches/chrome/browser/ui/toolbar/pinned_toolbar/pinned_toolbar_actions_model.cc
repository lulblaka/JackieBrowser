...
+  }
+
+  // Pin native JackieBrowser actions if their features are enabled
+  for (actions::ActionId id : jackiebrowser::kJackieBrowserNativeActionIds) {
+    const base::Feature* feature = jackiebrowser::GetFeatureForJackieBrowserAction(id);
