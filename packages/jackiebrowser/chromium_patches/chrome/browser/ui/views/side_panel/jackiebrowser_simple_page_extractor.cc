diff --git a/chrome/browser/ui/views/side_panel/jackiebrowser_simple_page_extractor.cc b/chrome/browser/ui/views/side_panel/jackiebrowser_simple_page_extractor.cc
new file mode 100644
index 0000000000000..4a801a5d847ea
--- /dev/null
+++ b/chrome/browser/ui/views/side_panel/jackiebrowser_simple_page_extractor.cc
@@ -0,0 +1,231 @@
...
+
+std::u16string JackieBrowserSimplePageExtractor::ExtractStructuredText(
