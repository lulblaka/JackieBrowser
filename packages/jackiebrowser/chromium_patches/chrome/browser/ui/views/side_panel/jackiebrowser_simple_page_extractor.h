diff --git a/chrome/browser/ui/views/side_panel/jackiebrowser_simple_page_extractor.h b/chrome/browser/ui/views/side_panel/jackiebrowser_simple_page_extractor.h
new file mode 100644
index 0000000000000..b9cbddf65327e
--- /dev/null
+++ b/chrome/browser/ui/views/side_panel/jackiebrowser_simple_page_extractor.h
@@ -0,0 +1,71 @@
...
+// JackieBrowser LLM features (LLM Chat, Clash of GPTs).
+//
...
+//         std::u16string text = side_panel::JackieBrowserSimplePageExtractor
+//             ::ExtractStructuredText(update);
+//         // Use extracted text...
+//       }), ...);
+//
+class JackieBrowserSimplePageExtractor {
+ public:
...
+  JackieBrowserSimplePageExtractor() = delete;
+  ~JackieBrowserSimplePageExtractor() = delete;
+  JackieBrowserSimplePageExtractor(const JackieBrowserSimplePageExtractor&) = delete;
+  JackieBrowserSimplePageExtractor& operator=(const JackieBrowserSimplePageExtractor&) = delete;
+};
+
+}  // namespace side_panel
+
