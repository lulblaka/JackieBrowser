...
+  return "jackiebrowser-first-run";
+}
+
...
+<html lang="en">
+<head>
+<title>JackieBrowser — First Run</title>
+<meta charset="UTF-8">
...
+ <p>JackieBrowser is an AI-powered browser that lets you build and run agents to automate tedious tasks. It looks like Chrome but reimagined for the AI era.</p>
+ <div class="actions">
+  </div>
+</section>
+
...
+  <a class="btn btn-accent" href="https://bit.ly/JackieBrowser-setup">Quick start guide</a>
...
+   <p class="muted" style="margin-top:.35rem">Navigate to <a href="chrome://settings/jackiebrowser"><code>chrome://settings/jackiebrowser</code></a> to configure your own API keys for various providers.</p>
...
+   Step 3: All done!
+  </div>
+  <div class="muted" style="margin-top:.4rem">Your ready to use JackieBrowser, have fun! This page can be always accessed again at <a href="chrome://jackiebrowser-first-run"><code>chrome://jackiebrowser-first-run</code></a></div>
+ </div>
+</section>
+
+<section>
...
+   Discord
+  </a>
+  <a href="https://github.com/jackiebrowser-ai/JackieBrowser">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>GitHub</title>
...
+  public:
+   NxtscapeFirstRunUIConfig() : DefaultWebUIConfig("chrome", "jackiebrowser-first-run") {}
+};
+
