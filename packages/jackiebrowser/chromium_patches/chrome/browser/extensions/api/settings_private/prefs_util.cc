...
+  // JackieBrowser preferences
+  (*s_allowlist)[prefs::kJackieBrowserProviders] = settings_api::PrefType::kString;
+  (*s_allowlist)[prefs::kJackieBrowserShowToolbarLabels] = settings_api::PrefType::kBoolean;
+  (*s_allowlist)[prefs::kJackieBrowserCustomProviders] = settings_api::PrefType::kString;
+
