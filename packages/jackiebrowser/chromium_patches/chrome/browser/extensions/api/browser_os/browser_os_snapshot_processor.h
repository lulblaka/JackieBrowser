...
+
+#ifndef CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_SNAPSHOT_PROCESSOR_H_
+#define CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_SNAPSHOT_PROCESSOR_H_
+
+#include <cstdint>
+#include <string>
...
+}  // namespace extensions
+
+#endif  // CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_SNAPSHOT_PROCESSOR_H_
