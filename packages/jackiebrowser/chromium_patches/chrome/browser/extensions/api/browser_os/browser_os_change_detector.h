...
+
+#ifndef CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_CHANGE_DETECTOR_H_
+#define CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_CHANGE_DETECTOR_H_
+
+#include <functional>
+
...
+class JackieBrowserChangeDetector : public content::WebContentsObserver {
+ public:
...
+  explicit JackieBrowserChangeDetector(content::WebContents* web_contents);
+  ~JackieBrowserChangeDetector() override;
+
+ private:
+  JackieBrowserChangeDetector(const JackieBrowserChangeDetector&) = delete;
+  JackieBrowserChangeDetector& operator=(const JackieBrowserChangeDetector&) = delete;
+
...
+  base::WeakPtrFactory<JackieBrowserChangeDetector> weak_factory_{this};
+};
+
+}  // namespace api
+}  // namespace extensions
+
+#endif  // CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_CHANGE_DETECTOR_H_
