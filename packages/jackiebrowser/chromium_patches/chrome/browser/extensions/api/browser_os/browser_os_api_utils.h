...
+
+#ifndef CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_API_UTILS_H_
+#define CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_API_UTILS_H_
+
+#include <optional>
+#include <string>
...
+}  // namespace extensions
+
+#endif  // CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_API_UTILS_H_
