...
+
+#ifndef CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_API_HELPERS_H_
+#define CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_API_HELPERS_H_
+
+#include <string>
+
...
+}  // namespace extensions
+
+#endif  // CHROME_BROWSER_EXTENSIONS_API_JACKIE_BROWSER_JACKIE_BROWSER_API_HELPERS_H_
