...
+  // Browser OS API
+  registry->RegisterFunction<api::JackieBrowserGetAccessibilityTreeFunction>();
+  registry->RegisterFunction<api::JackieBrowserGetInteractiveSnapshotFunction>();
+  registry->RegisterFunction<api::JackieBrowserClickFunction>();
+  registry->RegisterFunction<api::JackieBrowserInputTextFunction>();
+  registry->RegisterFunction<api::JackieBrowserClearFunction>();
+  registry->RegisterFunction<api::JackieBrowserExecuteJavaScriptFunction>();
+
