diff --git a/chrome/browser/jackiebrowser_server/jackiebrowser_server_prefs.h b/chrome/browser/jackiebrowser_server/jackiebrowser_server_prefs.h
new file mode 100644
index 0000000000000..03719e252a15a
--- /dev/null
+++ b/chrome/browser/jackiebrowser_server/jackiebrowser_server_prefs.h
@@ -0,0 +1,31 @@
...
+
+// Default port values for JackieBrowser server (10-port spacing)
...
+
+// Preference keys for JackieBrowser server configuration
...
+
+// Registers JackieBrowser server preferences in Local State (browser-wide prefs)
