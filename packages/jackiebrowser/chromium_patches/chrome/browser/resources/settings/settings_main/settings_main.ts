...
+import '../jackiebrowser_prefs_page/jackiebrowser_prefs_page.js';
...
+          return {about: false, settings: false, nxtscape: false, jackiebrowserPrefs: false};
         },
       },
...
+    const inJackieBrowserPrefs = routes.BROWSEROS_PREFS.contains(currentRoute);
+    this.showPages_ = {
+      about: inAbout,
+      settings: !inAbout && !inNxtscape && !inJackieBrowserPrefs,
+      nxtscape: inNxtscape,
+      jackiebrowserPrefs: inJackieBrowserPrefs
+    };
   }
