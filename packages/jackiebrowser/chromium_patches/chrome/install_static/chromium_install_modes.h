...
+            L"{CF887152-7CB8-4393-84CC-1BACF0EDE1D1}",  // JackieBrowser app GUID.
+        .base_app_name = L"JackieBrowser",              // A distinct base_app_name.
+        .base_app_id = L"JackieBrowser",                // A distinct base_app_id.
...
+            L"JackieBrowser HTML Document",         // Browser ProgID description.
+        .pdf_prog_id_prefix = L"BOSPDF",  // PDF ProgID prefix.
         .pdf_prog_id_description =
-            L"Chromium PDF Document",  // PDF ProgID description.
+            L"JackieBrowser PDF Document",  // PDF ProgID description.
         .active_setup_guid =
