...
BROWSEROS_SERVER_BINARIES: List[str] = [
    "jackiebrowser_server.exe",
    "codex.exe",
]


def get_jackiebrowser_server_binary_paths(build_output_dir: Path) -> List[Path]:
...
def sign_binaries(ctx: BuildContext, certificate_name: Optional[str] = None) -> bool:
    ...
    binaries_to_sign_first.extend(get_jackiebrowser_server_binary_paths(build_output_dir))
